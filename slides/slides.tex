...
% If you put background images in e.g. ~/Templates you can use the following:
 %   \usebackgroundtemplate{\includegraphics[width=\paperwidth]{\string~/Templates/front169.png}}
}{
    \usebackgroundtemplate{\includegraphics[width=\paperwidth]{front43.png}}
%    \usebackgroundtemplate{\includegraphics[width=\paperwidth]{\string~/Templates/front43.png}}
}
...
%\usebackgroundtemplate{\includegraphics[width=\paperwidth]{\string~/Templates/background.png}}
